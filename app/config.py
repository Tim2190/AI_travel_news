...
class Settings(BaseSettings):
    ...
    # Ключевые слова
    TOPIC_KEYWORDS: str = "экономика,финансы,туризм,жаңалық,банк,инфляция,инвестиции,казахстан,саяхат,валюта,рынок,бюджет,салық,заң,әкім,министр,президент,үкімет,тенге"
