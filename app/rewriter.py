...
class HybridRewriter:
    ...
    async def _process_gemini_kazakh(self, text: str) -> str:
        ...
        prompt = (
            ...
            "ЗАДАЧА: Перепиши этот официальный текст максимально просто. Сделай его полезным для людей. Не выдумывай фактов, строго опирайся на источник.\n"
    ...
    async def _process_groq_russian_pipeline(self, text: str) -> str:
        ...
        j_system = (
            ...
            "Твоя цель: передать факты доступным и понятным для обывателя языком. Не выдумывай никаких фактов и утверждений. Опирайся строго на первоисточник."
            "Формат: <b>Заголовок</b>\n\nТекст."
        )
