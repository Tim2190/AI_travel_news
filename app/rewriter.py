...
4) Шығарманың соңында тек постың мәтінін бер, түсініктеме жоқ.
...
Нәтиже — журнал колонкасы сияқты қысқа, ойлы текст. Шығарманың соңында ТЕК финалды мәтінді бер. Түсініктеме жоқ.
