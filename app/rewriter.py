...
3) 2–4 мағынаға сәйкес эмодзи қолдануға болады.
...
ФОРМАТ:
1) Алдымен — қысқа, тартатын тақырып бір жолда, # жоқ.
2) Төменде 3–5 абзац, әрқайсысы 1–3 сөйлем, Markdown жоқ.
3) Шығарманың соңында тек Telegram постының мәтінін бер, түсініктеме жоқ.
